...
public class ItemWaterThorn extends Item
{
        ...
        else
        {
            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
            {
                ...
                if (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1))
                {
                    ...
                    worldIn.setBlockState(blockpos1, CMContent.WATER_THORN.getDefaultState());
                    ...
                    worldIn.setBlockState(blockpos1, CMContent.WATER_THORN.getDefaultState(), 11);
