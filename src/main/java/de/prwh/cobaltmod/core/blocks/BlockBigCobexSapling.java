...
public class BlockBigCobexSapling extends BlockBush implements IGrowable {
	...
	public BlockBigCobexSapling() {
		super(Material.PLANTS);
		this.setUnlocalizedName("big_cobex_sapling");
		this.setRegistryName("big_cobex_sapling");
	...
	public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		WorldGenerator worldgenerator = (WorldGenerator) new WorldGenCobexBigTrees(true, 11 + rand.nextInt(3));
		if (worldIn.getBiome(pos) instanceof BiomeGenCobaltSwamp) {
			worldgenerator = (WorldGenerator) new WorldGenCobexBigTrees(true, 11 + rand.nextInt(3), true);
		}
