...
public class BlockBluishMushroom extends BlockBush {

	public BlockBluishMushroom() {
		super(Material.PLANTS);
		this.setUnlocalizedName("bluish_mushroom");
		this.setRegistryName("bluish_mushroom");
