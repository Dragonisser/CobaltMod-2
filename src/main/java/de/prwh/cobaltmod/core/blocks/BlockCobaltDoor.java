...
public class BlockCobaltDoor extends BlockDoor {
	...
	protected BlockCobaltDoor(Material materialIn) {
		super(materialIn);
		this.setUnlocalizedName("cobalt_door");
		this.setRegistryName("cobalt_door");
    ...
    {
        return new ItemStack(CMContent.COBALT_DOOR_I);
    }
    
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        return state.getValue(HALF) == BlockDoor.EnumDoorHalf.UPPER ? Items.AIR : CMContent.COBALT_DOOR_I;
    }
