...
public class MapGenCMCaves extends MapGenBase {
	...
	protected void addTunnel(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_,
	...
	protected boolean canReplaceBlock(IBlockState p_175793_1_, IBlockState p_175793_2_) {
		return p_175793_1_.getBlock() == CMContent.CORRUPTED_STONE ? true
				: (p_175793_1_.getBlock() == CMContent.COBALT_DIRT ? true : (p_175793_1_.getBlock() == CMContent.COBALT_GRASS) && p_175793_2_.getMaterial() != Material.WATER);
	}
	...
	private boolean isTopBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ) {
		...
		return (isExceptionBiome(biome) ? state.getBlock() == CMContent.COBALT_GRASS : state.getBlock() == biome.topBlock);
	}
