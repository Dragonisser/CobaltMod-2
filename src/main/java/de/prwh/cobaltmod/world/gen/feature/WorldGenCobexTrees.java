...
public class WorldGenCobexTrees extends WorldGenAbstractTree {
	private static final IBlockState DEFAULT_TRUNK = CMContent.COBEX_LOG.getDefaultState();
	private static final IBlockState DEFAULT_LEAF = CMContent.COBEX_LEAVES.getDefaultState()
	...
	public WorldGenCobexTrees(boolean p_i2027_1_) {
		this(p_i2027_1_, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
	}

	public WorldGenCobexTrees(boolean p_i2027_1_, int height) {
		this(p_i2027_1_, (height < 4) ? 4 : height, DEFAULT_TRUNK, DEFAULT_LEAF, false);
	}

	public WorldGenCobexTrees(boolean p_i2027_1_, boolean vines) {
		this(p_i2027_1_, 4, DEFAULT_TRUNK, DEFAULT_LEAF, vines);
	}

	public WorldGenCobexTrees(boolean p_i2027_1_, int height, boolean vines) {
		this(p_i2027_1_, (height < 4) ? 4 : height, DEFAULT_TRUNK, DEFAULT_LEAF, vines);
	}

	public WorldGenCobexTrees(boolean p_i46446_1_, int p_i46446_2_, IBlockState p_i46446_3_, IBlockState p_i46446_4_,
			boolean p_i46446_5_) {
		super(p_i46446_1_);
